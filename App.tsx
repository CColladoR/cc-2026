...
const App: React.FC = () => {
  ...
  return (
    <div className="relative max-w-6xl mx-auto px-6 py-12 md:py-20 transition-colors duration-500">
          ...
          <div className="reveal-text">
            <header className="mb-16">
              ...
              <div className="relative inline-block mb-12">
                ...
                <div className="absolute -right-8 -top-4 w-16 h-16 border-2 border-indigo-600/10 dark:border-indigo-400/10 rounded-full animate-pulse"></div>
              </div>
            </header>
                  ...
                  {[
                    ...
                    <div key={i} className="relative group/step">
                      ...
                      <div className="space-y-1.5">
                        <span className={`text-[9px] font-black tracking-widest uppercase ${item.active ? 'text-indigo-600 dark:text-indigo-400' : 'text-black/30 dark:text-white/30'}`}>
                          {item.year}
                        </span>
                        <h4 className="text-sm font-extrabold text-black dark:text-white leading-tight group-hover/step:text-indigo-600 dark:group-hover/step:text-indigo-400 transition-colors">
                          {item.title}
                        </h4>
      ...
      {/* Footer */}
      <footer className="mt-40 pt-16 border-t border-black/5 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 pb-12">
        <div className="flex items-center gap-4">
